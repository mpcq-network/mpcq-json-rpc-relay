...
//
// Additionally, the expected response has been modified to match MPCQ's current behavior.
...
//
// However, MPCQ does not currently return an error in this case, instead responding with:
// << {"result":"0x","jsonrpc":"2.0","id":1}
//
// The test has been adjusted accordingly, but this may indicate a bug in MPCQ's implementation.

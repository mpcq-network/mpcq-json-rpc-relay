...
//
// Reason for override: MPCQ JSON-RPC does not support dynamic fee transactions as defined in EIP-1559.
//
...
// MPCQ ignored the EIP-1559-specific fields and processed it as a legacy transaction (type 0).
// The presence of "max_fee_per_gas": "0x" and "type": 0 confirms that MPCQ currently does not support dynamic fee transactions as defined in EIP-1559.

As an implementation of [HIP 419](https://hips.hedera.com/hip/hip-482), the MPCQ JSON RPC Relay provides some [Ethereum JSON-RPC APIs](https://ethereum.github.io/execution-apis/api-documentation/) which implement the [JSON-RPC 2.0 Specification](https://www.jsonrpc.org/specification) to support Ethereum tools interacting with MPCQ nodes e.g. wallets, developer tools.
...
| Method                                                                                                                                    | Implementation Status                                     | MPCQ Nodes                              | MPCQ Specifics                                                                                                                          |
| ----------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- | ----------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
...
| [eth_coinbase](https://ethereum.org/en/developers/docs/apis/json-rpc/#eth_coinbase)                                                       | **Implemented** - Returns `-32601` (Method not supported) | N/A                                       | Fixed zero address as MPCQ has no traditional coinbase                                                                                  |
...
| [eth_feeHistory](https://ethereum.org/en/developers/docs/apis/json-rpc/#eth_feehistory)                                                   | **Implemented**                                           | Mirror Node                               | Returns MPCQ gas prices and utilization data                                                                                            |
| [eth_gasPrice](https://ethereum.org/en/developers/docs/apis/json-rpc/#eth_gasprice)                                                       | **Implemented**                                           | Mirror Node                               | Returns current MPCQ gas price in tinybars converted to wei                                                                             |
...
| [eth_getUncleByBlockHashAndIndex](https://ethereum.org/en/developers/docs/apis/json-rpc/#eth_getunclebyblockhashandindex)                 | **Implemented** - Returns `null`                          | N/A                                       | No uncle blocks in MPCQ                                                                                                                 |
| [eth_getUncleByBlockNumberAndIndex](https://ethereum.org/en/developers/docs/apis/json-rpc/#eth_getunclebyblocknumberandindex)             | **Implemented** - Returns `null`                          | N/A                                       | No uncle blocks in MPCQ                                                                                                                 |
| [eth_getUncleCountByBlockHash](https://ethereum.org/en/developers/docs/apis/json-rpc/#eth_getunclecountbyblockhash)                       | **Implemented** - Returns `0x0`                           | N/A                                       | No uncle blocks in MPCQ                                                                                                                 |
| [eth_getUncleCountByBlockNumber](https://ethereum.org/en/developers/docs/apis/json-rpc/#eth_getunclecountbyblocknumber)                   | **Implemented** - Returns `0x0`                           | N/A                                       | No uncle blocks in MPCQ                                                                                                                 |
| [eth_getWork](https://ethereum.org/en/developers/docs/apis/json-rpc/#eth_getwork)                                                         | **Implemented** - Returns `-32601` (Method not supported) | N/A                                       | Mining not applicable to MPCQ                                                                                                           |
| [eth_hashrate](https://ethereum.org/en/developers/docs/apis/json-rpc/#eth_hashrate)                                                       | **Implemented** - Returns `0x0`                           | N/A                                       | Mining not applicable to MPCQ                                                                                                           |
| [eth_maxPriorityFeePerGas](https://ethereum.org/en/developers/docs/apis/json-rpc/#eth_maxpriorityfeepergas)                               | **Implemented** - Returns `0x0`                           | N/A                                       | Returns same value as gasPrice since MPCQ doesn't have priority fees                                                                    |
| [eth_mining](https://ethereum.org/en/developers/docs/apis/json-rpc/#eth_mining)                                                           | **Implemented** - Returns `false`                         | N/A                                       | Mining not applicable to MPCQ                                                                                                           |
...
| [eth_protocolVersion](https://ethereum.org/en/developers/docs/apis/json-rpc/#eth_protocolversion)                                         | **Implemented** - Returns `-32601` (Method not supported) | N/A                                       | Not supported on MPCQ                                                                                                                   |
...
| [eth_submitHashrate](https://ethereum.org/en/developers/docs/apis/json-rpc/#eth_submithashrate)                                           | **Implemented** - Returns `-32601` (Method not supported) | N/A                                       | Mining not applicable to MPCQ                                                                                                           |
| [eth_submitWork](https://ethereum.org/en/developers/docs/apis/json-rpc/#eth_submitwork)                                                   | **Implemented** - Returns `false`                         | N/A                                       | Mining not applicable to MPCQ                                                                                                           |
| [eth_syncing](https://ethereum.org/en/developers/docs/apis/json-rpc/#eth_syncing)                                                         | **Implemented** - Returns `false`                         | N/A                                       | MPCQ network is always synced                                                                                                           |
...
| [engine\_\*](https://github.com/ethereum/execution-apis/blob/main/src/engine/openrpc/methods/capabilities.yaml)       | **Implemented** - Returns `-32601` (Method not supported) for all engine methods | N/A          | Engine API not applicable to MPCQ                    |
